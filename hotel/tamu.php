...
<?php
    ...
    <tr>
        ...
        <td><?php echo $tampil ["alamat_tamu"] ?></td>
        <td><?php echo $tampil ["status_perkawinan"] ?></td>
        <td><a href="hapus_tamu.php?id_tamu=<?php echo $tampil['id_tamu']; ?>"><button>Hapus</a>
            <a href="edit_tamu.php?id_tamu=<?php echo $tampil['id_tamu']; ?>"><button>edit</a> </td>
    </tr>
...
<a href="input_tamu.php">tambahkan data baru</a>
</html>