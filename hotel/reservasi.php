<html>
    ...
    <head>
    <link rel="stylesheet" href="style.css" href="tabel.css">
    </head>
<center>
<div class="main">
	<div class="navbar">
...
<?php
    ...
    <tr>
        ...
        <td><a href="hapus_reservasi.php?id_reservasi=<?php echo $tampil['id_reservasi']; ?>"><button>Hapus</a>
            <a href="edit_reservasi.php?id_reservasi=<?php echo $tampil['id_reservasi']; ?>"><button>edit</a> </td>
    </tr>
...
<a href="input_reservasi.php">tambahkan data baru</a>
</html>